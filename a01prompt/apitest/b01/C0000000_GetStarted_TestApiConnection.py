...
# ChatCompletion(id='chatcmpl-9OQX34i21294PRDQ3Y84ezhEP6U0f',
# choices=[Choice(finish_reason='stop', index=0, logprobs=None,
# message=ChatCompletionMessage(content='This is a test.',
# role='assistant', function_call=None, tool_calls=None))],
# created=1715608889, model='gpt-3.5-turbo-0125', object='chat.completion'
# , system_fingerprint=None, usage=CompletionUsage(completion_tokens=5,
# prompt_tokens=12, total_tokens=17))
